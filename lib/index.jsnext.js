...
class AttributeValidationError extends _extendableBuiltin(Error) {
...
const required = {
  ...
  array: new CompoundAttribute(x => typeofPlus(x) === 'array', () => [], (a, ev) => a.forEach(ev)),
  map: new CompoundAttribute(x => typeofPlus(x) === 'object', () => {}, (o, ev) => keys(o).forEach(n => ev(o[n], n))),
  tuple: elements => {
